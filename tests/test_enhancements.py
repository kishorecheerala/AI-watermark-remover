...
import unittest
import numpy as np
from remove_ai_watermarks.server import enhance_auto_color, apply_denoise, apply_aspect_ratio_fit
...
class TestPhotoEnhancements(unittest.TestCase):
    ...
    def test_denoise_filter(self):
        ...
        self.assertEqual(denoised.shape, (100, 100, 3))
    ...
    def test_aspect_ratio_fit_9_16(self):
        ...
        self.assertEqual(fitted.shape, (177, 100, 3))
